...
public class CameraSubsystem {
    ...
    private ContourPipeline pipeline; // pipeline designed to look for contours of the poles
    ...
    public CameraSubsystem(HardwareMap hardwareMap){
        ...
        // runs camera on a separate thread so it can run simultanously with everything else
